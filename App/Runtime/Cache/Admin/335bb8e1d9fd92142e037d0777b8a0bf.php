...
<div id="user_tool" style="padding: 5px;">
    ...
    <div style="padding: 0 0 0 7px;color: #333;">
        查询账号：<input type="text" class="textbox" name="search_username" style="width: 110px;" />
...
<form id="user_edit" style="margin: 0;padding: 5px 0 0 25px;color: #333;">
    ...
    <p>用户账号：<input type="text" name="edit_username" disabled="true" class="textbox" style="width: 200px;" /></p>
